...
public final class QuizActivity extends com.vesam.quiz.utils.base.BaseActivity {
    ...
    private final void initDetail(com.vesam.quiz.data.model.quiz_detail.Details details) {
    }
    
    private final void initResultDescriptionAnswer(com.vesam.quiz.data.model.quiz_detail.Description it) {
    }
    
    private final void initDetailFormat(com.vesam.quiz.data.model.quiz_detail.Description it) {
    }
